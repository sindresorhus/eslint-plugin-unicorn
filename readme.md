...
- [prefer-number-properties](docs/rules/prefer-number-properties.md) - Prefer `Number.{parseInt,parseFloat,isNaN,isFinite}()` and `Number.NaN` over global ones. *(fixable)*
