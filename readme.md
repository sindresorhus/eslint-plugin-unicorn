...
🎨✅ Set in the `css/recommended` [configuration](https://github.com/sindresorhus/eslint-plugin-unicorn#recommended-config).\
🎨☑️ Set in the `css/unopinionated` [configuration](https://github.com/sindresorhus/eslint-plugin-unicorn#recommended-config).\
...
| [expiring-todo-comments](docs/rules/expiring-todo-comments.md)                                             | Add expiration conditions to TODO comments.                                                                                    | 🎨✅ 🎨☑️ ✅ ☑️ |    |    |    |
...
| [no-abusive-eslint-disable](docs/rules/no-abusive-eslint-disable.md)                                       | Enforce specifying rules to disable in `eslint-disable` comments.                                                              | 🎨✅ 🎨☑️ ✅ ☑️ |    |    |    |
...
| [no-shorthand-property-overrides](docs/rules/no-shorthand-property-overrides.md)                           | Disallow shorthand properties that override related longhand properties.                                                       | 🎨✅ 🎨☑️ ✅ ☑️ |    |    |    |
...
| [no-transition-all](docs/rules/no-transition-all.md)                                                       | Disallow `all` as a transition property.                                                                                       | 🎨✅ 🎨☑️ ✅ ☑️ |    |    |    |
...
| [text-encoding-identifier-case](docs/rules/text-encoding-identifier-case.md)                               | Enforce consistent case for text encoding identifiers.                                                                         | 🎨✅ 🎨☑️ ✅ ☑️ | 🔧 | 💡 |    |
...
**Note**: The JavaScript preset configs also enable the correct [language options](https://eslint.org/docs/latest/use/configure/language-options). Language-specific presets require the corresponding language plugin and `language` setting.
...
The `css/recommended`, `css/unopinionated`, and `css/all` configs enable the corresponding CSS-compatible rules. Extend them from a config that selects the `css/css` language:
