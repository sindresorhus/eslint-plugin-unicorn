...
- [no-complex-iteratee-expression](docs/rules/no-complex-iteratee-expression.md) - Move complex iteratee expressions outside of `for..of` headers. *(partly fixable)*
