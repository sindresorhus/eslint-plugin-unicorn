...
| [no-useless-fallback-in-set-constructor](docs/rules/no-useless-fallback-in-set-constructor.md)   | Disallow useless values or fallbacks in `Set`, `Map`, `WeakSet`, or `WeakMap`.                                                                                                                                    | ✅ ☑️ | 🔧 |    |
