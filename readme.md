...
| [consistent-assert](docs/rules/consistent-assert.md)                                             | Enforce consistent assertion style with `node:assert`.                                                                                                                                                            | ✅ ☑️ | 🔧 |    |
...
| [consistent-empty-array-spread](docs/rules/consistent-empty-array-spread.md)                     | Prefer consistent types when spreading a ternary in an array literal.                                                                                                                                             | ✅ ☑️ | 🔧 |    |
...
| [switch-case-braces](docs/rules/switch-case-braces.md)                                           | Enforce consistent brace style for `case` clauses.                                                                                                                                                                | ✅ ☑️ | 🔧 |    |
...
This plugin also exports a `unopinionated` config removes rules from `recommended` which enforce subjective opinions.
