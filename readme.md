...
| [consistent-indexof-check](docs/rules/consistent-indexof-check.md)                               | Enforce consistent style when checking for element existence with `indexOf()` and `lastIndexOf()`.                                                                                                                | ✅  | 🔧 |    |
