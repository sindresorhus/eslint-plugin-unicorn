...
| [no-using-resource-escape](docs/rules/no-using-resource-escape.md)                                         | Disallow returning or exporting resources declared with `using`, including through capturing functions.                        |      |    |    |    |
