...
| [no-this-outside-of-class](docs/rules/no-this-outside-of-class.md)                                         | Disallow `this` outside of classes or non-arrow functions with an explicit TypeScript `this` parameter.                        | ✅    |    |    |    |
