...
| [no-useless-set-construction](docs/rules/no-useless-set-construction.md)                                   | Disallow unnecessary `Set` construction around `Set` methods.                                                                  | ✅ ☑️ | 🔧 |    |    |
...
| [prefer-array-from-async](docs/rules/prefer-array-from-async.md)                                           | Prefer `Array.fromAsync()` over array accumulation loops.                                                                      | ✅    | 🔧 | 💡 |    |
...
| [prefer-group-by](docs/rules/prefer-group-by.md)                                                           | Prefer `Object.groupBy()` or `Map.groupBy()` over manual grouping.                                                             | ✅    | 🔧 |    |    |
...
| [prefer-temporal-conversion](docs/rules/prefer-temporal-conversion.md)                                     | Prefer direct Temporal conversion methods.                                                                                     | ✅ ☑️ | 🔧 | 💡 |    |
...
| [prefer-uint8array-base64](docs/rules/prefer-uint8array-base64.md)                                         | Prefer `Uint8Array#toBase64()` and `Uint8Array.fromBase64()` over legacy base64 conversions and manual postprocessing.         |      | 🔧 | 💡 |    |
| [prefer-uint8array-hex](docs/rules/prefer-uint8array-hex.md)                                               | Prefer `Uint8Array#toHex()` and `Uint8Array.fromHex()` over manual and Buffer hex conversions.                                 |      | 🔧 | 💡 |    |
