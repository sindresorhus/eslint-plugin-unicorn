...
| [no-this-outside-of-class](docs/rules/no-this-outside-of-class.md)                                         | Disallow `this` outside of classes or functions with an explicit TypeScript `this` parameter.                                  | ✅    |    |    |    |
