...
| [prefer-combinable-action](docs/rules/prefer-combinable-action.md)                               | Enforce combining multiple `Array#push()`, `Element#classList.{add,remove}()`, and `importScripts()` into one call.                                                                                               | ✅  | 🔧 | 💡 |
