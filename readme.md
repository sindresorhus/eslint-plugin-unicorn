...
| [no-invalid-argument-count](docs/rules/no-invalid-argument-count.md)                                       | Disallow calling functions with an invalid number of arguments.                                                                | ✅ ☑️ |    |    |
...
| [prefer-object-destructuring-defaults](docs/rules/prefer-object-destructuring-defaults.md)                 | Prefer object destructuring defaults over default object literals with spread.                                                 | ✅ ☑️ |    | 💡 |
