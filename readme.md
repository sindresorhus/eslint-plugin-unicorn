...
- [no-fn-reference-in-iterator](docs/rules/no-fn-reference-in-iterator.md) - Renamed to [`no-array-callback-reference`](docs/rules/no-array-callback-reference.md).
