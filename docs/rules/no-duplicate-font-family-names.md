...
This rule checks the `font-family` property and statically valid `font` shorthands in style rules. It compares names case-insensitively and normalizes quotes, CSS escapes, and whitespace. For example, `Times New Roman`, `"times new roman"`, and `Times\20 New\20 Roman` refer to the same family.
