...
📝 Prefer a single object destructuring declaration per source object.
...
Prefer one object destructuring declaration when consecutive declarations read from the same local `const` object.
