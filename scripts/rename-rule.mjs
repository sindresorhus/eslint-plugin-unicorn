...
async function renameRule(from, to) {
	...
	await renameFile(
		`test/snapshots/${from}.mjs.md`,
		`test/snapshots/${to}.mjs.md`
	);
	await renameFile(
		`test/snapshots/${from}.mjs.snap`,
		`test/snapshots/${to}.mjs.snap`
	);
	...
	await import('./generate-rules-table.mjs');
	await import('./generate-usage-example.mjs');
}
