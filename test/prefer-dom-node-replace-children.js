...
test({
	valid: [
		...
		'globalThis.document.innerHTML = "";',
		'self.document.innerHTML = "";',
		'top.document.innerHTML = "";',
		'parent.document.innerHTML = "";',
		'frames.document.innerHTML = "";',
		'const node = document; node.innerHTML = "";',
		'const node = window.document; node.innerHTML = "";',
		'const node = self.document; node.innerHTML = "";',
		'const node = top.document; node.innerHTML = "";',
		'const document = globalThis.document; document.innerHTML = "";',
		'element.textContent = "";',
		'element["outerHTML"] = "";',
		...
		'document["createElement"]("template").innerHTML = "";',
		'document["createElementNS"]("http://www.w3.org/1999/xhtml", "template").innerHTML = "";',
		typescript('document["createElement" as const]("template").innerHTML = "";'),
		typescript('document["createElementNS" as const]("http://www.w3.org/1999/xhtml", "template").innerHTML = "";'),
		{
	...
	invalid: [
		...
		},
		{
			...
			errors: [error],
			output: 'const element = document.createElement("div"); element.replaceChildren();',
		},
		{
