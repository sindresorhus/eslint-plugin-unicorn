			...
			errors: [
				{
					...error,
					message:
						'/[A-Za-z0-9_]+[0-9]?\\.[A-Za-z0-9_]*/ can be optimized to /\\w+\\d?\\.\\w*/'
				}
			],
			...
			errors: [
				{
					...error,
					message:
						'/^by @([a-zA-Z0-9-]+)/ can be optimized to /^by @([\\d-A-Za-z]+)/'
				}
			],
			...
			errors: [
				{
					...error,
					message:
						'/[GgHhIiå.Z:a-f"0-8%A*ä]/ can be optimized to /["%*.0-8:AG-IZa-iäå]/'
				}
			],
