...
test.snapshot({
	valid: [
		...
		'import escapeStringRegexp from \'escape-string-regexp\'; const escaped = escapeStringRegexp?.(string);',
		'import {notEscape} from \'escape-string-regexp\'; const escaped = notEscape(string);',
		'import {escapeStringRegexp} from \'escape-string-regexp\'; const escaped = escapeStringRegexp(string);',
	...
	invalid: [
		...
		'import {default as escapeStringRegexp} from \'escape-string-regexp\'; const escaped = escapeStringRegexp(string);',
		...
		'import {default as escapeRegExp} from \'lodash.escaperegexp\'; const escaped = escapeRegExp(string);',
