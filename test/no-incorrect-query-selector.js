...
test.snapshot({
	valid: [
		...
		'document.querySelector("form")?.at(0);',
		'document.querySelector("form").at?.(0);',
		'document.querySelector("form")?.item(0);',
		'document.querySelector("form").item?.(0);',
		'document.querySelector("form")[0];',
		'document.querySelector("form").at(0);',
		'document.querySelector("form").item(0);',
		'document.querySelector("form")[0] = form;',
		'document.querySelector("form")[0]++;',
		'delete document.querySelector("form")[0];',
		'for (document.querySelector("form")[0] in object) {}',
		'for (document.querySelector("form")[0] of iterable) {}',
		'document.querySelector("form") === null;',
		'document.querySelector("form") !== null;',
		'document.querySelector("form") == undefined;',
		'document.querySelector("form") != undefined;',
		'const undefined = null; document.querySelector("form") === undefined;',
		'const undefined = null; document.querySelectorAll("form") === undefined;',
		'document.querySelectorAll("form") === nodes;',
		'document.querySelectorAll("form").length === 0;',
		'let elements = document.querySelectorAll("form"); elements === null;',
		'const elements = document.querySelectorAll("form"); const alias = elements; alias === null;',
	],
	invalid: [
		...
		'document.querySelectorAll(".item") == null;',
		'document.querySelectorAll(".item") != null;',
		'document.querySelectorAll(".item") === undefined;',
		'document.querySelectorAll(".item") !== undefined;',
		'null === document.querySelectorAll(".item");',
		'undefined !== document.querySelectorAll(".item");',
		'document.querySelectorAll(".item") /* keep */ === null;',
		'document.querySelector(".item") === undefined;',
		'document.querySelector(".item") !== undefined;',
		'undefined === document.querySelector(".item");',
