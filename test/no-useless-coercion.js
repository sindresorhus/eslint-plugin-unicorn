...
test.snapshot({
	valid: [
		...
		'Number(a - b)',
		'Number(a % b)',
		'const modes = new Set(["foo"]); modes.clear(); Number(modes.size ? value : "value");',
		...
		'const object = {value: true}; Object.defineProperty(object, "value", {get() { return false; }}); BigInt(object.value ? 1n : value);',
		'Number(x?.length)',
		'Boolean(x ?? y)',
		'Boolean(x || false)',
		'Boolean(a && b)',
