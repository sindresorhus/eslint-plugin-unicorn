...
test.snapshot({
	valid: [
		...
		htmlCase('<link rel="preload" as="image" imagesrcset="./assets/logo-1x.png 1x, ./assets/logo-2x.png 2x">'),
		...
		cssCase(String.raw`@\69mport "./style.css"; @\6e amespace svg url("./missing.css");`),
		cssCase('.icon { background: url(./assets/logo-1x.png?raw=1#icon); }'),
		cssCase('.icon { background: image-set("./assets/logo-1x.png" 1x, "./assets/logo-2x.png" 2x type("image/png")); }'),
	...
	invalid: [
		...
		htmlCase('<link rel="preload" as="image" imagesrcset="./assets/logo-1x.png 1x, ./assets/missing.png 2x">'),
		...
		cssCase('.icon { background: image-set("./assets/missing.png" 1x, "./assets/LOGO.svg" 2x); }'),
		...
		cssCase(String.raw`@\69mport "./missing.css";`),
...
test({
	...
	invalid: [
		...
		{
			code: '<a href="./assets/%7E%46ILE.svg"></a>',
			filename: htmlFilename,
