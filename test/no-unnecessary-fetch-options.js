...
test.snapshot({
	valid: [
		...
		'const alias = condition; var condition = true; fetch(url, {method: alias ? "GET" : value})',
		'const alias = condition; var condition = true; fetch(url, {signal: alias ? undefined : value})',
		...
		'fetch("/", {method: ({get value() { return "POST"; }}).value})',
		'const object = {value: "GET"}; Object.defineProperty(object, "value", {get() { return "POST"; }}); fetch("/", {method: String(object.value)})',
		'const object = {value: "GET"}; Object.defineProperty(object, "value", {get() { return "POST"; }}); fetch("/", {method: ({...object}).value})',
		'const object = {value: "GET"}; Object.defineProperty(object, "value", {get() { return "POST"; }}); fetch("/", {method: ({value: object.value}).value})',
		'const object = {value: "GET"}; Object.defineProperty(object, "value", {get() { return "POST"; }}); fetch("/", {method: [object.value][0]})',
		'const prototype = {value: "GET"}; Object.defineProperty(prototype, "value", {get() { return "POST"; }}); fetch("/", {method: ({__proto__: prototype}).value})',
		'fetch(url, {method: (sideEffect(), "GET")})',
		'fetch(url, {method})',
