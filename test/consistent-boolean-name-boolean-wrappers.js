...
test({
	valid: [
		...
		validBooleanWrapper('interface NullablePropertyWrapper {value: boolean | null} declare const isReady: NullablePropertyWrapper;', {wrappers: {NullablePropertyWrapper: 'value'}}),
		validBooleanWrapper('interface NullablePromiseWrapper {get(): Promise<boolean> | undefined} declare const isReady: NullablePromiseWrapper;', {wrappers: {NullablePromiseWrapper: 'get'}}),
	...
	invalid: [
		...
		invalidBooleanWrapper([
			'namespace First { export interface StorageItem {get(): Promise<boolean>} }',
			'namespace Second { export interface StorageItem {value: boolean} }',
			'declare const isFirst: First.StorageItem;',
			'declare const isSecond: Second.StorageItem;',
		].join('\n'), {wrappers: {StorageItem: 'get'}}),
