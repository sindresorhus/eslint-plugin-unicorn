...
test.snapshot({
	valid: [
		...
		{code: String.raw`:--custom, :--custom(value), :\2d \2d custom {}`, language: languages.css},
	...
	invalid: [
		...
		{code: ':has(> .foo:foucs), :nth-child(2n of :hovr), ::slotted(.bar:foucs) {}', language: languages.css},
		...
		{code: '::theme-part(.foo) {}', language: languages.css},
		{code: '::--custom {}', language: languages.css},
