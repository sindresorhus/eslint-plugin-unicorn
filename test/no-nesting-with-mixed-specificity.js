...
test.snapshot({
	valid: withCssLanguage([
		...
		':is(dialog, #dialog::before), dialog { & .close {} }',
		...
		'::view-transition-group(/* comment */ *), ::view-transition-group-children(*), ::view-transition-image-pair(*), ::view-transition-old(*), ::view-transition-new(*), :where(*) { & .close {} }',
		'::view-transition-group(*), dialog { & .close {} }',
		'::view-transition-group-children(*), dialog { & .close {} }',
