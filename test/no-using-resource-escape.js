...
test.snapshot({
	valid: [
		...
		'function f() { using resource = acquire(); return resource ? resource.read() : resource; }',
		'function f() { using resource = acquire(); return resource ? resource.read() : () => resource.read(); }',
		...
		'using resource = acquire(); export default resource ? resource.read() : resource;',
	...
	invalid: [
		...
		'function f() { using resource = acquire(); return resource ? resource : undefined; }',
		'function f() { using resource = acquire(), other = acquire(); return resource ? undefined : [resource, other]; }',
		'function f() { using resource = acquire(); return resource || other; }',
...
test.snapshot({
	valid: [
		...
		'function f() { using resource = acquire(); return (resource as Resource) ? resource.read() : resource; }',
