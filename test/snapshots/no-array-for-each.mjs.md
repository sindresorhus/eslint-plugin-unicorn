...
> Output
    ...
    `␊
      1 | for (const [index = element, element] of array.entries()) {}␊
    `
...
> Output
    ...
    `␊
      1 | for (const [index = foo, {foo}] of array.entries()) {}␊
    `
...
> Output
    ...
    `␊
      1 | for (const [{bar = element}, element] of array.entries()) {}␊
    `
...
> Output
    ...
    `␊
      1 | for (const [{bar = foo}, {foo}] of array.entries()) {}␊
    `
