...
> Output
    ...
    `␊
      1 | for (let [index = indexDefaultValue, element = elementDefaultValue] of foo.entries()) {}␊
    `
...
> Output
    ...
    `␊
      1 | if (foo) for (let [index = indexDefaultValue, element = elementDefaultValue] of foo.entries()) {}␊
    `
