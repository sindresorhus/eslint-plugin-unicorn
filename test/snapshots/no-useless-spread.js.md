...
## invalid(61): Object.assign(target, {...{a}})

> Input

    `␊
      1 | Object.assign(target, {...{a}})␊
    `
...
## invalid(1): Object.assign(target, {...source})
...
> Error 1/1
    ...
    ␊
    Suggestion 1/1: Remove the object literal wrapper.:␊
      1 | Object.assign(target, source)␊
    `

## invalid(2): Object.assign(target, {...a}, {...b})

> Input

    `␊
      1 | Object.assign(target, {...a}, {...b})␊
    `
...
## invalid(3): Object.assign(target, first, {...second})

> Input

    `␊
      1 | Object.assign(target, first, {...second})␊
    `
...
## invalid(4): Object.assign(...args, target, {...source})

> Input

    `␊
      1 | Object.assign(...args, target, {...source})␊
    `
...
## invalid(5): Object.assign(target, {...first, ...second}, third)

> Input

    `␊
      1 | Object.assign(target, {...first, ...second}, third)␊
    `
...
## invalid(6): Object.assign(target, {...source,}, third)

> Input

    `␊
      1 | Object.assign(target, {...source,}, third)␊
    `
...
## invalid(7): Object.assign(target, {...(( source ))})
...
## invalid(8): Object.assign(target, {...(foo, bar)})

> Input

    `␊
      1 | Object.assign(target, {...(foo, bar)})␊
    `
...
## invalid(9): Object.assign(target, {/* keep */ ...source})

> Input

    `␊
      1 | Object.assign(target, {/* keep */ ...source})␊
    `
...
## invalid(3): new WeakSet(...iterable)
...
## invalid(4): new WeakMap(...iterable)
...
> Error 1/1
    ...
    Message:␊
    > 1 | const typed = new BigUint64Array([...iterable], byteOffset, length)␊
        |                                  ^^^^^^^^^^^^^ \`new BigUint64Array(…)\` accepts an iterable as an argument, it's unnecessary to convert to an array.␊
    ␊
    Output:␊
      1 | const typed = new BigUint64Array(iterable, byteOffset, length)␊
    `
...
## invalid(18): function foo(array: number[]) { return [...array.map(value => value * 2)]; }

> Input 'file.ts'

    `␊
      1 | function foo(array: number[]) { return [...array.map(value => value * 2)]; }␊
    `
...
## invalid(19): function foo(array: number[]) { return [...array.filter(Boolean)]; }

> Input 'file.ts'

    `␊
      1 | function foo(array: number[]) { return [...array.filter(Boolean)]; }␊
    `
...
## invalid(20): function foo(array: number[]) { return [...array.flatMap(value => value)]; }

> Input 'file.ts'

    `␊
      1 | function foo(array: number[]) { return [...array.flatMap(value => value)]; }␊
    `
