...
> Error 1/1
    ...
    Message:␊
    > 1 | Object.assign(target, {...source})␊
        |                        ^^^ Spreading an object literal in \`Object.assign(…)\` is unnecessary.␊
    ␊
    Suggestion 1/1: Remove the object spread.:␊
      1 | Object.assign(target, source)␊
    `

## invalid(2): Object.assign(target, {...first, ...second}, third)
...
## invalid(3): Object.assign(target, {...source,}, third)
...
## invalid(4): Object.assign(target, {...(( source ))})
...
## invalid(5): Object.assign(target, {...(foo, bar)})
...
## invalid(6): Object.assign(target, {/* keep */ ...source})
