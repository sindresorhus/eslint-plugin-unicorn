...
## invalid(32): parentNode?.removeChild(foo)
...
## invalid(37): foo.bar?.parentNode.removeChild(foo.bar)
...
## invalid(38): foo.bar?.parentNode.removeChild(foo["bar"])
...
## invalid(39): a?.b.parentNode.removeChild(a.b)
...
## invalid(40): a?.b?.parentNode.removeChild(a.b)
...
## invalid(42): a.b?.c.parentNode.removeChild(foo)
...
## invalid(43): a[b?.c].parentNode.removeChild(foo)
