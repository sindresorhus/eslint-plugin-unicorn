...
## invalid(11): const method = "head"; new Request(url, {method, body: "foo=bar"})
...
## invalid(12): const method = "head"; fetch(url, {method, body: "foo=bar"})
...
## invalid(13): fetch(url, {body}, extraArgument)
...
## invalid(14): new Request(url, {body}, extraArgument)
...
## invalid(15): fetch(url, { body: undefined, body: 'foo=bar', });
...
## invalid(16): new Request(url, { body: undefined, body: 'foo=bar', });
...
## invalid(17): fetch(url, { method: 'post', body: 'foo=bar', method: 'HEAD', });
...
## invalid(18): new Request(url, { method: 'post', body: 'foo=bar', method: 'HEAD', });
