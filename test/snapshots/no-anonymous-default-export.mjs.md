...
## invalid(25): export default function () {}
...
## invalid(26): export default function* () {}
...
## invalid(31): export default async function * /* comment */ () {}
...
## invalid(32): export default async function * // comment () {}
...
## invalid(33): let Foo, Foo_, foo, foo_ export default async function * () {}
...
## invalid(34): let Foo, Foo_, foo, foo_ export default (async function * () {})
...
## invalid(36): export default async () => {}
...
## invalid(41): /* comment 1 */ export /* comment 2 */ default /* comment 3 */ () => {}
...
## invalid(42): // comment 1 export // comment 2 default // comment 3 () => {}
...
## invalid(43): let Foo, Foo_, foo, foo_ export default async () => {}
