...
## invalid(2): @decorator @decorator(class {}) export default class {}
...
## invalid(1): export default @decorator(class {}) class {}

> Input

    `␊
      1 | export default @decorator(class {}) class {}␊
    `
...
> Error 1/1
    ...
    --------------------------------------------------------------------------------␊
    Suggestion 1/1: Name it as \`Foo\`.␊
      1 | export default @decorator(class {}) class Foo {}␊
    `
