...
## invalid(25): schema.fetch().catch(handle)
...
## invalid(26): userSchema.validate().catch(handle)
...
## invalid(27): someSchema.optional.catch(handle)
...
## invalid(28): someSchema.parseAsync(value).catch(handle)
...
## invalid(29): someSchema.then(foo).catch(bar)
