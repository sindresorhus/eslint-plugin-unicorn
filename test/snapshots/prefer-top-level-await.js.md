...
## invalid(28): schema.fetch().catch(handle)
...
## invalid(29): userSchema.validate().catch(handle)
...
## invalid(30): someSchema.optional.catch(handle)
...
## invalid(31): someSchema.parseAsync(value).catch(handle)
...
## invalid(32): someSchema.then(foo).catch(bar)
