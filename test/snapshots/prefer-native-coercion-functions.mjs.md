...
## Invalid #1 1 | const foo = v => String(v)
...
## Invalid #2 1 | const foo = v => Number(v)
...
## Invalid #3 1 | const foo = v => BigInt(v)
...
## Invalid #4 1 | const foo = v => Boolean(v)
...
## Invalid #5 1 | const foo = v => Symbol(v)
...
## Invalid #6 1 | const foo = v => { 2 | return String(v); 3 | }
...
## Invalid #7 1 | const foo = function (v) { 2 | return String(v); 3 | }
...
## Invalid #8 1 | function foo(v) { return String(v); }
...
## Invalid #9 1 | export default function foo(v) { return String(v); }
...
## Invalid #10 1 | export default function (v) { return String(v); }
...
## Invalid #11 1 | class A { 2 | foo(v) { 3 | return String(v); 4 | } 5 | 6 | bar() {} 7 | }
...
## Invalid #12 1 | class A { 2 | static foo(v) { 3 | return String(v); 4 | } 5 | 6 | bar() {} 7 | }
...
## Invalid #13 1 | class A { 2 | #foo(v) { 3 | return String(v); 4 | } 5 | 6 | bar() {} 7 | }
...
## Invalid #14 1 | class A { 2 | static #foo(v) { 3 | return String(v); 4 | } 5 | 6 | bar() {} 7 | }
...
## Invalid #15 1 | object = { 2 | foo(v) { 3 | return String(v); 4 | }, 5 | bar 6 | }
...
## Invalid #16 1 | object = { 2 | foo: function(v) { 3 | return String(v); 4 | }, 5 | bar 6 | }
...
## Invalid #17 1 | object = { 2 | [function(v) {return String(v);}]: 1, 3 | }
...
## Invalid #18 1 | const foo = (v, extra) => String(v)
...
## Invalid #19 1 | const foo = (v, ) => String(v, extra)
...
## Invalid #20 1 | const foo = (v, ) => /* comment */ String(v)
...
## Invalid #4 1 | array.findLast(v => v)
...
## Invalid #6 1 | array.findIndex(v => v)
...
## Invalid #7 1 | array.findLastIndex(v => v)
...
## Invalid #9 1 | array.some(v => { 2 | return v; 3 | })
...
## Invalid #10 1 | array.some(function (v) { 2 | return v; 3 | })
...
## Invalid #11 1 | array.some((v, extra) => v)
...
## Invalid #12 1 | array.some((v, ) => /* comment */ v)
