...
## Invalid(7): values.findIndex(x => x === (0, "foo"))
...
## Invalid(12): foo.findIndex(function a(x) { return x === (function (a) { return a(this) === arguments[1] }).call(thisObject, anotherFunctionNamedA, secondArgument) })
