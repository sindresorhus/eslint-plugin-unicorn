...
> Output
    ...
    `␊
      1 | const index = foo.indexOf(bar); index === undefined␊
    `
...
> Output
    ...
    `␊
      1 | const index = foo.lastIndexOf(bar); index === undefined␊
    `
...
> Output
    ...
    `␊
      1 | const index = foo.findIndex(bar); index === undefined␊
    `
...
> Output
    ...
    `␊
      1 | const index = foo.findLastIndex(bar); index === undefined␊
    `
