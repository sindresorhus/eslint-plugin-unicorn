...
## Invalid(12): array.map(() => {}, thisArgumentHasSideEffect())
...
## Invalid(2): array.map(callback, (0, thisArgument))
...
## Invalid(3): array.map(function () {}, thisArgument)
...
## Invalid(4): array.map(function callback () {}, thisArgument)
...
## Invalid(5): array.map( foo as bar, (( thisArgument )),)
...
## Invalid(6): array.map( (( foo as bar )), (( thisArgument )),)
...
## Invalid(7): array.map( (( 0, callback )), (( thisArgument )),)
...
## Invalid(8): array.map((0, () => {}), thisArgument)
...
## Invalid(9): array.map(callback.bind(foo), thisArgument)
