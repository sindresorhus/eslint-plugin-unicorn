...
## invalid(24): let[,,...thirdElement] = foo;
...
## invalid(26): const[,,...thirdElement] = foo;
...
## invalid(28): var[,,...thirdElement] = foo;
...
## invalid(29): let[]=[],[,,thirdElement] = foo;
...
## invalid(32): const [foo,, bar] = parts;
