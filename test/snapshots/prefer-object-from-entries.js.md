...
## invalid(44): const object = {}; for (let [key, value] of pairs) { object[key] = value; } console.log(object);
...
## invalid(45): let object = Object.create(null); for (const [key, value] of pairs) { object[key] = value; }
