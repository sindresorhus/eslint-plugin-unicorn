...
## invalid(40): const object = {}; // Comment for (const [key, value] of pairs) { object[key] = value; }
...
## invalid(41): const object = {}; for (const [key, value] of pairs) { // Comment object[key] = value; }
...
## invalid(42): const object = {}; for (const [key, value] of pairs) { object[key] = value; } // Comment
...
## invalid(43): const object = {}; for (const [key, value] of ((pairs))) { object[key] = value; }
...
## invalid(44): const object = {}; for (const [key, value] of pairs) { object[(key)] = (value); }
...
## invalid(45): const object = {}; for (let [key, value] of pairs) { object[key] = value; } console.log(object);
...
## invalid(46): let object = Object.create(null); for (const [key, value] of pairs) { object[key] = value; }
