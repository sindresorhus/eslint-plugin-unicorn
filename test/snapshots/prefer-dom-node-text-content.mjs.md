...
## Invalid #3 1 | node.innerText = 'foo';
...
## Invalid #4 1 | innerText.innerText;
...
## Invalid #5 1 | const {innerText} = node;
...
## Invalid #6 1 | const {innerText,} = node;
...
## Invalid #7 1 | const {innerText: text} = node;
...
## Invalid #8 1 | const {innerText = "default text"} = node;
...
## Invalid #9 1 | const {innerText: text = "default text"} = node;
...
## Invalid #11 1 | ({innerText: text} = node);
...
## Invalid #12 1 | ({innerText = "default text"} = node);
...
## Invalid #13 1 | ({innerText: text = "default text"} = node);
...
## Invalid #14 1 | function foo({innerText}) {return innerText}
...
## Invalid #15 1 | for (const [{innerText}] of elements);
