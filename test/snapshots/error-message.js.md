...
## invalid(18): throw new Error(false)

> Input

    `␊
      1 | throw new Error(false)␊
    `
...
## invalid(19): const condition = true; let value; new Error(condition ? {} : value);

> Input

    `␊
      1 | const condition = true; let value; new Error(condition ? {} : value);␊
    `
...
## invalid(20): const object = {value: 1}; new Error(Object.freeze(object).value);

> Input

    `␊
      1 | const object = {value: 1}; new Error(Object.freeze(object).value);␊
    `
...
## invalid(21): const error = new RangeError;
...
## invalid(22): throw Object.assign(new Error(), {foo})
