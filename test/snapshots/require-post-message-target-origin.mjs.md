...
## Invalid #1 1 | window.postMessage(message)
...
## Invalid #2 1 | self.postMessage(message)
...
## Invalid #3 1 | globalThis.postMessage(message)
...
## Invalid #4 1 | foo.postMessage(message )
...
## Invalid #5 1 | foo.postMessage( ((message)) )
...
## Invalid #6 1 | foo.postMessage(message,)
...
## Invalid #7 1 | foo.postMessage(message , )
...
## Invalid #8 1 | foo.window.postMessage(message)
...
## Invalid #9 1 | document.defaultView.postMessage(message)
...
## Invalid #10 1 | getWindow().postMessage(message)
