...
## invalid(4): if (condition ? element.classList.add(className) : element.classList.remove(className));
...
## invalid(5): function foo() { return!foo ? element.classList.add(className) : element.classList.remove(className) }
...
## invalid(6): foo condition ? (( element )).classList.add(className) : element.classList.remove(className);
