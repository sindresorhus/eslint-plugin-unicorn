...
## invalid(25): if (condition) { (element as Element).classList.add('className'); } else { (element as Element).classList.remove('className'); }

> Input

    `␊
      1 | if (condition) {␊
      2 | 	(element as Element).classList.add('className');␊
      3 | } else {␊
      4 | 	(element as Element).classList.remove('className');␊
      5 | }␊
    `
...
> Error 1/1
    ...
    ␊
    Output:␊
      1 | (element as Element).classList.toggle('className', condition);␊
    `

## invalid(26): if (condition) { element!.classList.add('className'); } else { element!.classList.remove('className'); }
