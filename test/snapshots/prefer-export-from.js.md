...
## invalid(49): import {foo} from 'foo'; export {foo as 'bar'};
...
## invalid(50): import {'foo' as foo} from 'foo'; export {foo as "foo"};
...
## invalid(51): import {'fo\u{20}o' as foo} from 'foo'; export {foo as "fo o"};
...
## invalid(53): import {'default' as foo} from 'foo'; export {foo};
...
## invalid(54): import {'default' as foo} from 'foo'; export default foo;
...
## invalid(55): import {'*' as foo} from 'foo'; export {foo};
...
## invalid(56): import {named} from 'foo'; use(named); export {named};
...
## invalid(57): import {foo} from 'foo'; // This is not JSDoc. export const baz = foo;
...
> Error 1/1
    ...
    Output:␊
      ...
      2 | // This is not JSDoc.␊
      3 |␊
      4 | export {foo as baz} from 'foo';␊
    `

## invalid(58): import {foo} from 'foo'; /** * Documentation for the direct export. */ export {foo};
...
> Input
    ...
    `␊
      ...
      2 |␊
      3 | /**␊
      4 |  * Documentation for the direct export.␊
      5 |  */␊
      6 | export {foo};␊
    `
...
> Error 1/1
    ...
    Output:␊
      ...
      5 |  */␊
      6 |␊
      7 | export {foo} from 'foo';␊
    `

## invalid(59): import {foo} from 'foo'; /* * This is not JSDoc. */ export const baz = foo;
...
> Error 1/1
    ...
    Output:␊
      ...
      4 |  */␊
      5 |␊
      6 | export {foo as baz} from 'foo';␊
    `

## invalid(60): import {foo} from 'foo'; /*** This is not JSDoc. */ export const baz = foo;
...
## invalid(61): import {foo} from 'foo'; /** This comment belongs to the import. */ export const baz = foo;

> Input

    `␊
      1 | import {foo} from 'foo'; /** This comment belongs to the import. */␊
      2 | export const baz = foo;␊
    `
...
> Error 1/1
    ...
    ␊
    Output:␊
      1 |  /** This comment belongs to the import. */␊
      2 |␊
      3 | export {foo as baz} from 'foo';␊
    `

## invalid(62): import {foo} from 'foo'; /** * This comment is detached from the declaration. */ export const baz = foo;
...
> Input
    ...
    `␊
      ...
      2 |␊
      3 | /**␊
      4 |  * This comment is detached from the declaration.␊
      5 |  */␊
      6 |␊
      7 | export const baz = foo;␊
    `
...
## invalid(8): import {documented, other, unused} from 'foo'; /** * Preserve this documentation. */ export const documentedAlias = documented; export {other};
...
> Input
    ...
    ␊
    Code:␊
      1 | import {documented, other, unused} from 'foo';␊
      2 |␊
      3 | /**␊
      4 |  * Preserve this documentation.␊
      5 |  */␊
      6 | export const documentedAlias = documented;␊
      7 | export {other};␊
    `
...
> Error 1/1
    ...
    Message:␊
      ...
      6 | export const documentedAlias = documented;␊
    > 7 | export {other};␊
        |         ^^^^^ Use \`export…from\` to re-export \`other\`.␊
    ␊
    Suggestion 1/1: Switch to \`export…from\`.:␊
      1 | import {documented,  unused} from 'foo';␊
      2 |␊
      3 | /**␊
      4 |  * Preserve this documentation.␊
      5 |  */␊
