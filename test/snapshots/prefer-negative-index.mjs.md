...
## Invalid #1 1 | foo.slice(foo.length - 2, foo.length - 1)
...
## Invalid #2 1 | foo.splice(foo.length - 1, 1)
...
## Invalid #3 1 | foo.bar.slice(foo["bar"].length - 1)
...
## Invalid #4 1 | foo[`bar`].slice(foo["bar"].length - 1)
...
## Invalid #5 1 | foo[1].slice(foo["1"].length - 1)
...
## Invalid #6 1 | foo['bar'].slice(foo["bar"].length - 1)
...
## Invalid #7 1 | foo.at(foo.length - 1); 2 | Array.prototype.at.call(foo, foo.length - 2); 3 | Array.prototype.at.apply(foo, [foo.length - 3]);
...
## Invalid #8 1 | foo.toSpliced(foo.length - 3, foo.length - 6)
...
## Invalid #9 1 | Array.prototype.toSpliced.call(foo, foo.length - 3, foo.length - 6)
...
## Invalid #10 1 | [].toSpliced.call(foo, foo.length - 3, foo.length - 6)
...
## Invalid #11 1 | foo.with(foo.length - 3, foo.length - 6)
...
## Invalid #12 1 | Array.prototype.with.call(foo, foo.length - 3, foo.length - 6)
