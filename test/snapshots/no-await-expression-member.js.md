...
## invalid(15): let property = (await getObject()).property

> Input

    `␊
      1 | let property = (await getObject()).property␊
    `
...
> Error 1/1
    ...
    ␊
    Output:␊
      1 | let {property} = await getObject()␊
    `

## invalid(16): const renamed = (await getObject()).property
...
## invalid(17): (await promise).foo.bar

> Input

    `␊
      1 | (await promise).foo.bar␊
    `
...
## invalid(18): const property = (await getObject())[property]
...
## invalid(19): const property = (await getObject())?.property
...
## invalid(20): const {propertyOfProperty} = (await getObject()).property
...
## invalid(21): const {propertyOfProperty} = (await getObject()).propertyOfProperty
...
## invalid(22): const [firstElementOfProperty] = (await getObject()).property
...
## invalid(23): const [firstElementOfProperty] = (await getObject()).firstElementOfProperty
...
## invalid(24): firstElement = (await getArray())[0]
...
## invalid(25): property = (await getArray()).property
