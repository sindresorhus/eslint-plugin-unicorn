...
## invalid(3): async function * foo () { foo.map((0, bar)); foo.map(yield bar); foo.map(yield* bar); foo.map(() => bar); foo.map(() => bar); foo.map(bar &&= baz); foo.map(bar || baz); foo.map(bar + bar); foo.map(+ bar); foo.map(++ bar); foo.map(new Function('')); }
...
> Error 4/4
    ...
    Suggestion 1/3: Replace function with \`… => …(element)\`.␊
       ...
       6 | 	foo.map(() => bar);␊
       7 | 	foo.map(bar &&= baz);␊
       8 | 	foo.map((element) => (bar || baz)(element));␊
       9 | 	foo.map(bar + bar);␊
      10 | 	foo.map(+ bar);␊
      11 | 	foo.map(++ bar);␊
      12 | 	foo.map(new Function(''));␊
    ...
    Suggestion 2/3: Replace function with \`… => …(element, index)\`.␊
       ...
       6 | 	foo.map(() => bar);␊
       7 | 	foo.map(bar &&= baz);␊
       8 | 	foo.map((element, index) => (bar || baz)(element, index));␊
       9 | 	foo.map(bar + bar);␊
      10 | 	foo.map(+ bar);␊
      11 | 	foo.map(++ bar);␊
      12 | 	foo.map(new Function(''));␊
    ...
    Suggestion 3/3: Replace function with \`… => …(element, index, array)\`.␊
       ...
       6 | 	foo.map(() => bar);␊
       7 | 	foo.map(bar &&= baz);␊
       8 | 	foo.map((element, index, array) => (bar || baz)(element, index, array));␊
       9 | 	foo.map(bar + bar);␊
      10 | 	foo.map(+ bar);␊
      11 | 	foo.map(++ bar);␊
      12 | 	foo.map(new Function(''));␊
