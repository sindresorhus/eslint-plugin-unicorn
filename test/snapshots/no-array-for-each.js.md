...
> Error 1/2
    ...
    ␊
    Output:␊
      1 | for (const arrayInArray of array) arrayInArray.forEach(element => bar(element));␊
    `
...
> Error 2/2
    ...
    ␊
    Output:␊
      1 | array.forEach((arrayInArray) => { for (const element of arrayInArray) bar(element) });␊
    `
...
> Error 2/2
    ...
    ␊
    Output:␊
      1 | array.forEach((arrayInArray) => { if (arrayInArray) for (const element of arrayInArray) bar(element) });␊
    `
