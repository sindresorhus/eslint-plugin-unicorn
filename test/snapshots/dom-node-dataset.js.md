...
## invalid(19): (a + b).dataset.unicorn;
...
## invalid(20): (a + b).dataset.unicorn = "🦄";
...
## invalid(21): delete (a + b).dataset.unicorn;
...
## invalid(22): "unicorn" in (a + b).dataset
...
## invalid(23): Object.hasOwn((a + b).dataset, "unicorn")
...
## invalid(24): (a + b).dataset.hasOwnProperty("unicorn")
...
## invalid(25): const {unicorn} = (a + b).dataset;
...
## invalid(27): element.dataset.foo = (a, b);
...
## invalid(28): foo() delete (a + b).dataset.unicorn;
...
## invalid(29): foo() "unicorn" in (a + b).dataset
...
## invalid(30): foo() Object.hasOwn((a + b).dataset, "unicorn")
...
## invalid(31): const {unicorn} = element.dataset;
...
## invalid(32): const {unicorn: myVar} = element.dataset;
...
## invalid(33): const {foo, bar} = element.dataset;
...
## invalid(34): let {foo, bar} = element.dataset;
...
## invalid(35): const result = element.dataset.unicorn = "🦄";
...
## invalid(36): if (delete element.dataset.unicorn) {}
...
## invalid(37): const {unicorn = "default"} = element.dataset;
...
## invalid(38): const {...rest} = element.dataset;
...
## invalid(39): const {foo, bar} = element.querySelector("#selector").dataset;
...
## invalid(40): for (const {foo} = element.dataset;;) {}
...
## invalid(41): export const {foo} = element.dataset;
