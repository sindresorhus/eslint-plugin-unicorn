...
## invalid(39): const result = element.dataset.unicorn = "🦄";
...
## invalid(40): if (delete element.dataset.unicorn) {}
...
## invalid(41): if (delete element?.dataset.unicorn) {}
...
## invalid(42): const {unicorn = "default"} = element.dataset;
...
## invalid(43): const {...rest} = element.dataset;
...
## invalid(44): const {foo, bar} = element.querySelector("#selector").dataset;
...
## invalid(45): for (const {foo} = element.dataset;;) {}
...
## invalid(46): export const {foo} = element.dataset;
