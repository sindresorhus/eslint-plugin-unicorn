...
## invalid(11): function foo(collection: string[] | {map(callback: (value: string) => string, thisArgument: unknown): string[]}) { collection.map(value => value, thisArgument); }

> Input

    `␊
      1 | function foo(collection: string[] | {map(callback: (value: string) => string, thisArgument: unknown): string[]}) { collection.map(value => value, thisArgument); }␊
    `
...
> Error 1/1
    ...
    ␊
    Output:␊
      1 | function foo(collection: string[] | {map(callback: (value: string) => string, thisArgument: unknown): string[]}) { collection.map(value => value); }␊
    `

## invalid(12): Array.from(iterableOrArrayLike, () => {}, thisArgument)
...
## invalid(13): Array.fromAsync(iterableOrArrayLike, () => {}, thisArgument)
...
## invalid(14): array.map(() => {}, thisArgument,)
...
## invalid(16): Array.from(iterableOrArrayLike, () => {}, thisArgument,)
...
## invalid(17): Array.fromAsync(iterableOrArrayLike, () => {}, thisArgument,)
...
## invalid(20): Array.from(iterableOrArrayLike, () => {}, thisArgumentHasSideEffect())
...
## invalid(21): Array.fromAsync(iterableOrArrayLike, () => {}, thisArgumentHasSideEffect())
...
## invalid(22): const array: string[] = []; array.map(value => value, thisArgument);
