...
## invalid(13): function foo(collection: string[] | {map(callback: (value: string) => string, thisArgument: unknown): string[]}) { collection.map(value => value, thisArgument); }
...
## invalid(16): array.map(() => {}, thisArgument,)
...
## invalid(17): array.map(() => {}, (0, thisArgument),)
...
## invalid(18): Array.from(iterableOrArrayLike, () => {}, thisArgument,)
...
## invalid(19): Array.fromAsync(iterableOrArrayLike, () => {}, thisArgument,)
...
## invalid(21): array?.map(() => {}, thisArgumentHasSideEffect())
...
## invalid(22): Array.from(iterableOrArrayLike, () => {}, thisArgumentHasSideEffect())
...
## invalid(23): Array.fromAsync(iterableOrArrayLike, () => {}, thisArgumentHasSideEffect())
...
## invalid(24): array.map(() => {}, object.property)
...
## invalid(25): array.map(() => {}, /* comment */ thisArgument)
...
## invalid(26): array.map(callback, /* comment */ thisArgument)
...
## invalid(28): const array: [string] = [""]; array.map(value => value, thisArgument);
...
## invalid(29): function f(foo: Int8Array) { foo.map(() => {}, thisArgument); }

> Input

    `␊
      1 | function f(foo: Int8Array) { foo.map(() => {}, thisArgument); }␊
    `
...
> Error 1/1
    ...
    ␊
    Output:␊
      1 | function f(foo: Int8Array) { foo.map(() => {}); }␊
    `

## invalid(30): declare function getBytes(): Int8Array; getBytes().map(value => value, thisArgument);

> Input 'file.ts'

    `␊
      1 | declare function getBytes(): Int8Array; getBytes().map(value => value, thisArgument);␊
    `
...
> Error 1/1
    ...
    ␊
    Output:␊
      1 | declare function getBytes(): Int8Array; getBytes().map(value => value);␊
    `
