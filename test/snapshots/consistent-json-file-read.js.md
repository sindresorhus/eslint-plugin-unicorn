...
## invalid(7): JSON.parse(await fs.readFileSync(file));
...
## invalid(8): JSON.parse(fs.readFileSync(file));
...
## invalid(9): const buffer = await fs.readFile(file); JSON.parse(buffer);
...
## invalid(10): let buffer = await fs.readFile(file); JSON.parse(buffer);
...
## invalid(11): const foo = await await fs.readFile(file); const bar = await await foo; const baz = await bar; JSON.parse(baz);
...
## invalid(12): var foo = await fs.readFile(file); let bar = await foo; const baz = await bar; JSON.parse(baz);
...
## invalid(13): const foo = fs.readFile(file); async function fn1() { const bar = await foo; function fn2() { const baz = bar; JSON.parse(baz); } }
...
## invalid(14): const buffer = fs.readFile(file); /* Should report */ const foo = buffer; async function fn1() { const buffer = fs.readFile(file); /* Should NOT report */ JSON.parse(await foo); }
...
## invalid(15): const buffer = fs.readFile(file); /* Should report */ const foo = buffer; async function fn1() { const buffer = fs.readFile(file); /* Should NOT report */ const baz = foo; for (;;) { const buffer = fs.readFile(file); /* Should NOT report */ JSON.parse(await baz); } }
...
## invalid(16): const foo = fs.readFile(file); function fn1() { JSON.parse(foo); function fn2() { const foo = "{}"; } }
...
## invalid(17): const buffer = await NOT_A_FS_MODULE.readFile(file); JSON.parse(buffer);
