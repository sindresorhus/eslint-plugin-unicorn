...
## invalid(12): const isEmpty = foo.length < 1 ? true : false;
...
## invalid(13): const isEmpty = foo.length <= 0;
...
## invalid(16): bar(!foo.length || foo.length)
...
## invalid(17): const bar = void !foo.length;
...
## invalid(18): const isNotEmpty = Boolean(foo.length)
...
## invalid(19): if (!!Boolean(foo.length)) {}
...
## invalid(20): const isNotEmpty = Boolean(foo.length || bar)
...
## invalid(21): const isEmpty = Boolean(!foo.length)
...
## invalid(22): const isEmpty = Boolean(foo.length === 0)
...
## invalid(23): const isNotEmpty = !Boolean(foo.length === 0)
...
## invalid(24): const isEmpty = !Boolean(!Boolean(foo.length === 0))
...
## invalid(26): if (foo.size && bar.length) {}
...
## invalid(27): function foo() {return!foo.length}
...
## invalid(28): function foo() {throw!foo.length}
...
## invalid(29): async function foo() {await!foo.length}
...
## invalid(30): function * foo() {yield!foo.length}
...
## invalid(31): function * foo() {yield*!foo.length}
...
## invalid(35): a instanceof!foo.length
...
## invalid(37): export default!foo.length
...
## invalid(38): if(true){}else!foo.length
...
## invalid(39): do!foo.length;while(true) {}
...
## invalid(40): switch(foo){case!foo.length:{}}
...
## invalid(41): for(const a of!foo.length);
...
## invalid(42): for(const a in!foo.length);
