...
## invalid(12): const isEmpty = foo.length <= 0;
...
## invalid(15): bar(!foo.length || foo.length)
...
## invalid(16): const bar = void !foo.length;
...
## invalid(17): const isNotEmpty = Boolean(foo.length)
...
## invalid(18): const isNotEmpty = Boolean(foo.length || bar)
...
## invalid(19): const isEmpty = Boolean(!foo.length)
...
## invalid(20): const isEmpty = Boolean(foo.length === 0)
...
## invalid(21): const isNotEmpty = !Boolean(foo.length === 0)
...
## invalid(22): const isEmpty = !Boolean(!Boolean(foo.length === 0))
...
## invalid(24): if (foo.size && bar.length) {}
...
## invalid(25): function foo() {return!foo.length}
...
## invalid(26): function foo() {throw!foo.length}
...
## invalid(27): async function foo() {await!foo.length}
...
## invalid(28): function * foo() {yield!foo.length}
...
## invalid(29): function * foo() {yield*!foo.length}
...
## invalid(33): a instanceof!foo.length
...
## invalid(35): export default!foo.length
...
## invalid(36): if(true){}else!foo.length
...
## invalid(37): do!foo.length;while(true) {}
...
## invalid(38): switch(foo){case!foo.length:{}}
...
## invalid(39): for(const a of!foo.length);
...
## invalid(40): for(const a in!foo.length);
