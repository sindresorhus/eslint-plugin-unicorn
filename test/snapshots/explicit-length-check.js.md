...
## invalid(18): if (!!Boolean(foo.length)) {}
...
## invalid(19): const isNotEmpty = Boolean(foo.length || bar)
...
## invalid(20): const isEmpty = Boolean(!foo.length)
...
## invalid(21): const isEmpty = Boolean(foo.length === 0)
...
## invalid(22): const isNotEmpty = !Boolean(foo.length === 0)
...
## invalid(23): const isEmpty = !Boolean(!Boolean(foo.length === 0))
...
## invalid(25): if (foo.size && bar.length) {}
...
## invalid(26): function foo() {return!foo.length}
...
## invalid(27): function foo() {throw!foo.length}
...
## invalid(28): async function foo() {await!foo.length}
...
## invalid(34): a instanceof!foo.length
...
## invalid(36): export default!foo.length
...
## invalid(37): if(true){}else!foo.length
...
## invalid(38): do!foo.length;while(true) {}
...
## invalid(39): switch(foo){case!foo.length:{}}
...
## invalid(40): for(const a of!foo.length);
...
## invalid(41): for(const a in!foo.length);
