...
## invalid(6): if (foo.bar && foo.bar.length) {}
...
## invalid(7): if (foo.length || foo.bar()) {}
...
## invalid(11): do {} while (foo.length);
...
## invalid(12): for (let i = 0; (bar && !foo.length); i ++) {}
...
## invalid(13): const isEmpty = foo.length < 1;
...
## invalid(14): const isEmpty = foo.length < 1 ? true : false;
...
## invalid(15): const isEmpty = foo.length <= 0;
...
## invalid(18): bar(!foo.length || foo.length)
...
## invalid(19): const bar = void !foo.length;
...
## invalid(20): const isNotEmpty = Boolean(foo.length)
...
## invalid(21): if (!!Boolean(foo.length)) {}
...
## invalid(22): const isNotEmpty = Boolean(foo.length || bar)
...
## invalid(23): const isEmpty = Boolean(!foo.length)
...
## invalid(24): const isEmpty = Boolean(foo.length === 0)
...
## invalid(25): const isNotEmpty = !Boolean(foo.length === 0)
...
## invalid(26): const isEmpty = !Boolean(!Boolean(foo.length === 0))
...
## invalid(28): if (foo.size && bar.length) {}
...
## invalid(29): function foo() {return!foo.length}
...
## invalid(30): function foo() {throw!foo.length}
...
## invalid(31): async function foo() {await!foo.length}
...
## invalid(32): function * foo() {yield!foo.length}
...
## invalid(33): function * foo() {yield*!foo.length}
...
## invalid(37): a instanceof!foo.length
...
## invalid(39): export default!foo.length
...
## invalid(40): if(true){}else!foo.length
...
## invalid(41): do!foo.length;while(true) {}
...
## invalid(42): switch(foo){case!foo.length:{}}
...
## invalid(43): for(const a of!foo.length);
...
## invalid(44): for(const a in!foo.length);
