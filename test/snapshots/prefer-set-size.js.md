...
## invalid(19): function getSize(set: unknown) { return [...(set as Set<string>)].length; }

> Input

    `␊
      1 | function getSize(set: unknown) { return [...(set as Set<string>)].length; }␊
    `
...
> Error 1/1
    ...
    ␊
    Output:␊
      1 | function getSize(set: unknown) { return (set as Set<string>).size; }␊
    `

## invalid(20): function getSize(set: unknown) { return Array.from(set as Set<string>).length; }

> Input

    `␊
      1 | function getSize(set: unknown) { return Array.from(set as Set<string>).length; }␊
    `
