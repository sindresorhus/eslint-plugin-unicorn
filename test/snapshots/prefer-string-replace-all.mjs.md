...
## Invalid #1 1 | foo.replace(/a/g, bar)
...
## Invalid #2 1 | foo/* comment 1 */ 2 | .replace/* comment 2 */( 3 | /* comment 3 */ 4 | /a/g // comment 4 5 | , 6 | bar 7 | )
...
## Invalid #7 1 | foo.replace(/a/gu, bar)
...
## Invalid #8 1 | foo.replace(/a/ug, bar)
...
## Invalid #9 1 | foo.replace(/[a]/g, bar)
...
## Invalid #10 1 | foo.replace(/a?/g, bar)
...
## Invalid #11 1 | foo.replace(/.*/g, bar)
...
## Invalid #12 1 | foo.replace(/a|b/g, bar)
...
## Invalid #13 1 | foo.replace(/\W/g, bar)
...
## Invalid #14 1 | foo.replace(/\u{61}/g, bar)
...
## Invalid #15 1 | foo.replace(/\u{61}/gu, bar)
...
## Invalid #16 1 | foo.replace(/\u{61}/gv, bar)
...
## Invalid #17 1 | foo.replace(/]/g, "bar")
...
## Invalid #18 1 | foo.replace(/a/gi, bar)
...
## Invalid #19 1 | foo.replace(/a/gui, bar)
...
## Invalid #20 1 | foo.replace(/a/uig, bar)
...
## Invalid #21 1 | foo.replace(/a/vig, bar)
...
## Invalid #22 1 | const pattern = new RegExp("foo", "g"); foo.replace(pattern, bar)
...
## Invalid #23 1 | foo.replace(new RegExp("foo", "g"), bar)
...
## Invalid #24 1 | foo.replace(/a]/g, _)
...
## Invalid #25 1 | foo.replace(/[a]/g, _)
...
## Invalid #26 1 | foo.replace(/a{1/g, _)
...
## Invalid #27 1 | foo.replace(/a{1}/g, _)
...
## Invalid #30 1 | foo.replace(/\cM\cj/g, _)
...
## Invalid #31 1 | foo.replace(/\x22/g, _)
...
## Invalid #32 1 | foo.replace(/\x27/g, _)
...
## Invalid #34 1 | foo.replace(/\u{1f600}/gu, _)
...
## Invalid #36 1 | foo.replace(/\u{20}/gu, _)
...
## Invalid #37 1 | foo.replace(/\u{20}/gv, _)
...
## Invalid #38 1 | foo.replaceAll(/a]/g, _)
...
## Invalid #41 1 | foo.replaceAll(/a very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very long string/g, _)
