...
## invalid(17): class Foo { set bar(v) { [...this.bar] = array; } }
...
## invalid(18): class Foo { set bar(v) { ({property: this.bar} = object); } }
...
## invalid(19): class Foo { set bar(v) { ({property: this.bar = defaultValue} = object); } }
...
## invalid(20): class Foo { set bar(v) { for (this.bar of array) {} } }
...
## invalid(21): class Foo { set bar(v) { for (this.bar in object) {} } }
