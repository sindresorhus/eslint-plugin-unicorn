...
## invalid(16): (foo as string[]).slice((foo as string[]).length - 1)
...
## invalid(17): (array as number[]).splice((array as number[]).length - 2, 1)
...
## invalid(18): Array.prototype.slice.call(foo as any[], (foo as any[]).length - 1)
...
## invalid(19): foo!.slice(foo!.length - 1)
...
## invalid(20): array!.splice(array!.length - 2, 1)
