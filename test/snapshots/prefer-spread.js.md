...
## invalid(26): Array.from(set).concat("bar")
...
## invalid(27): foo.concat([2, 3]).concat(4)
...
## invalid(31): let sortedScores = scores.concat().sort((a, b) => b[0] - a[0]);
...
## invalid(33): foo.concat(bar, 2, 3, baz)
...
## invalid(34): async function a() {return [].concat(await bar)}
...
## invalid(35): async function a() {return [].concat((0, bar))}
...
## invalid(36): async function a() {return [].concat(((await bar)))}
...
## invalid(38): async function a() {return (await bar).concat(1)}
...
## invalid(49): const EMPTY_STRING = "" const EMPTY_STRING_IN_ARRAY = "" const EMPTY_STRING_IN_ARRAY_OF_ARRAY = "" const array = [].concat( undefined, null, EMPTY_STRING, false, 0, [EMPTY_STRING_IN_ARRAY], [[EMPTY_STRING_IN_ARRAY_OF_ARRAY]] )
...
## invalid(52): foo.concat(bar, 2, [3, 4], baz, 5, [6, 7])
...
## invalid(53): foo.concat(bar, 2, 3, ...baz)
...
## invalid(59): if (test) foo.concat(1)
...
## invalid(61): if (test) {} else foo.concat(1)
...
## invalid(64): for (a in b) foo.concat(1)
...
## invalid(65): for (const a of b) foo.concat(1)
...
## invalid(66): while (test) foo.concat(1)
...
## invalid(67): do foo.concat(1); while (test)
...
## invalid(68): with (foo) foo.concat(1)
...
## invalid(69): const baz = [2]; call(foo, ...[bar].concat(baz));
...
## invalid(75): foo.concat([1], /* keep */ bar)
...
## invalid(76): foo.concat(/* keep */ [1], bar)
...
## invalid(77): foo.concat( // keep [1], bar, )
...
## invalid(79): foo/* keep */.concat([1], bar)
...
## invalid(83): [1].concat( // eslint-disable-next-line no-restricted-syntax [2, 3], )
