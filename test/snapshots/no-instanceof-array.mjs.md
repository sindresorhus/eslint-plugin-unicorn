...
## Invalid #10 1 | <template><div v-if="array instanceof Array" v-for="element of array"></div></template>
...
## Invalid #11 1 | <template><div v-if="(( (( array )) instanceof (( Array )) ))" v-for="element of array"></div></template>
...
## Invalid #12 1 | <template><div>{{(( (( array )) instanceof (( Array )) )) ? array.join(" | ") : array}}</div></template>
...
## Invalid #13 1 | <script>const foo = array instanceof Array</script>
...
## Invalid #14 1 | <script>const foo = (( (( array )) instanceof (( Array )) ))</script>
