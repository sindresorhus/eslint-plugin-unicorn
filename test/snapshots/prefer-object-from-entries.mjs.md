...
> Output
    ...
    `␊
      1 | Object.fromEntries(pairs.map(() => ['object', object]));␊
    `
...
> Output
    ...
    `␊
      1 | Object.fromEntries(pairs.map(() => ['key', Object.keys(object)]));␊
    `
...
> Error 1/1
    ...
    `␊
    > 1 | _.pairs(pairs)␊
        | ^^^^^^^ Prefer \`Object.fromEntries()\` over \`_.pairs()\`.␊
    `

## Invalid #2
      1 | lodash.pairs(pairs)
...
> Error 1/1
    ...
    `␊
    > 1 | lodash.pairs(pairs)␊
        | ^^^^^^^^^^^^ Prefer \`Object.fromEntries()\` over \`lodash.pairs()\`.␊
    `

## Invalid #3
      1 | underscore.pairs(pairs)
...
> Error 1/1
    ...
    `␊
    > 1 | underscore.pairs(pairs)␊
        | ^^^^^^^^^^^^^^^^ Prefer \`Object.fromEntries()\` over \`underscore.pairs()\`.␊
    `
