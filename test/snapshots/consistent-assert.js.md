...
## invalid(12): import assert from 'assert'; assert(/** before comment */ typeof foo === 'string', 'foo must be a string' /** after comment */);
...
> Input
    ...
    `␊
      1 | import assert from 'assert';␊
      2 |␊
      3 | assert(/** before comment */ typeof foo === 'string', 'foo must be a string' /** after comment */);␊
    `
...
> Output
    ...
    `␊
      1 | import assert from 'assert';␊
      2 |␊
      3 | assert.ok(/** before comment */ typeof foo === 'string', 'foo must be a string' /** after comment */);␊
    `
...
## invalid(13): import {default as foo} from 'node:assert'; foo(1);

> Input

    `␊
      1 | import {default as foo} from 'node:assert';␊
      2 | foo(1);␊
    `
