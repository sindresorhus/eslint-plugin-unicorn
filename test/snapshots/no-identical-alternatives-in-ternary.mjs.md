...
## invalid(16): async function foo() { return a ? b ? c : await 1 : await 1; }
...
## invalid(17): function* foo() { return a ? b ? c : yield 1 : yield 1; }
