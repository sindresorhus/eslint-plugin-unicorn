...
## Invalid #2 1 | const filename = "foo.JS";
...
## Invalid #3 1 | const filename = "foo.Js";
...
## Invalid #4 1 | const filename = "foo.jS";
...
## Invalid #5 1 | const filename = "index.JS";
...
## Invalid #6 1 | const filename = "foo..JS";
