...
## invalid(59): function varCheck() { { var WeakMap = function() {}; } // This should not be reported return WeakMap() } function constCheck() { { const Array = function() {}; } return Array() } function letCheck() { { let Map = function() {}; } return Map() }
