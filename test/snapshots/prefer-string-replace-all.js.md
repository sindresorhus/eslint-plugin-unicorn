...
## invalid(32): foo.replace(/\cM\cj/g, _)
...
## invalid(33): foo.replace(/\x22/g, _)
...
## invalid(34): foo.replace(/\x27/g, _)
...
## invalid(36): foo.replace(/\u{1f600}/gu, _)
...
## invalid(38): foo.replace(/\u{20}/gu, _)
...
## invalid(39): foo.replace(/\u{20}/gv, _)
...
## invalid(40): foo.replaceAll(/a]/g, _)
...
## invalid(43): foo.replaceAll(/a very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very long string/g, _)
