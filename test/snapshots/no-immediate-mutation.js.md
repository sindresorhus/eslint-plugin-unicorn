...
## invalid(7): const otherVariable = 1, object = {foo: 1}; object.bar = 2;
...
## invalid(14): const object = {foo: 1}; object.object = 2;
...
## invalid(11): const set = new Set([1, 2]); set.add(3); foo()
...
## invalid(17): let map = new Map([["foo", 1]]); map.set("bar", 2);
