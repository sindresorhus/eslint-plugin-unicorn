...
## invalid(13): const hasCompleted = true const downloaded = hasCompleted

> Input

    `␊
      1 | const hasCompleted = true␊
      2 | const downloaded = hasCompleted␊
    `
...
> Error 1/1
    ...
    Suggestion 1/5: Replace \`downloaded\` with \`isDownloaded\`.␊
      1 | const hasCompleted = true␊
      2 | const isDownloaded = hasCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 2/5: Replace \`downloaded\` with \`wasDownloaded\`.␊
      1 | const hasCompleted = true␊
      2 | const wasDownloaded = hasCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 3/5: Replace \`downloaded\` with \`hasDownloaded\`.␊
      1 | const hasCompleted = true␊
      2 | const hasDownloaded = hasCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 4/5: Replace \`downloaded\` with \`canDownloaded\`.␊
      1 | const hasCompleted = true␊
      2 | const canDownloaded = hasCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 5/5: Replace \`downloaded\` with \`shouldDownloaded\`.␊
      1 | const hasCompleted = true␊
      2 | const shouldDownloaded = hasCompleted␊
    `

## invalid(14): const hasCompleted = () => progress === 100 const downloaded = hasCompleted()
...
> Input
    ...
    `␊
      1 | const hasCompleted = () => progress === 100␊
      2 |␊
      3 | const downloaded = hasCompleted()␊
    `
...
> Error 1/1
    ...
    Suggestion 1/5: Replace \`downloaded\` with \`isDownloaded\`.␊
      1 | const hasCompleted = () => progress === 100␊
      2 |␊
      3 | const isDownloaded = hasCompleted()␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 2/5: Replace \`downloaded\` with \`wasDownloaded\`.␊
      1 | const hasCompleted = () => progress === 100␊
      2 |␊
      3 | const wasDownloaded = hasCompleted()␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 3/5: Replace \`downloaded\` with \`hasDownloaded\`.␊
      1 | const hasCompleted = () => progress === 100␊
      2 |␊
      3 | const hasDownloaded = hasCompleted()␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 4/5: Replace \`downloaded\` with \`canDownloaded\`.␊
      1 | const hasCompleted = () => progress === 100␊
      2 |␊
      3 | const canDownloaded = hasCompleted()␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 5/5: Replace \`downloaded\` with \`shouldDownloaded\`.␊
      1 | const hasCompleted = () => progress === 100␊
      2 |␊
      3 | const shouldDownloaded = hasCompleted()␊
    `
...
## invalid(4): const completed = true const hasCompleted = () => completed
...
> Input
    ...
    `␊
      1 | const completed = true␊
      2 |␊
      3 | const hasCompleted = () => completed␊
    `
...
> Error 1/1
    ...
    Suggestion 1/5: Replace \`completed\` with \`isCompleted\`.␊
      1 | const isCompleted = true␊
      2 |␊
      3 | const hasCompleted = () => isCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 2/5: Replace \`completed\` with \`wasCompleted\`.␊
      1 | const wasCompleted = true␊
      2 |␊
      3 | const hasCompleted = () => wasCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 3/5: Replace \`completed\` with \`hasCompleted\`.␊
      1 | const hasCompleted2 = true␊
      2 |␊
      3 | const hasCompleted = () => hasCompleted2␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 4/5: Replace \`completed\` with \`canCompleted\`.␊
      1 | const canCompleted = true␊
      2 |␊
      3 | const hasCompleted = () => canCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 5/5: Replace \`completed\` with \`shouldCompleted\`.␊
      1 | const shouldCompleted = true␊
      2 |␊
      3 | const hasCompleted = () => shouldCompleted␊
    `

## invalid(5): const completed = true const hasCompleted = () => completed const hasCompleted2 = () => completed const hasCompleted3 = () => completed const hasCompleted4 = () => completed
...
> Input
    ...
    `␊
      ...
      2 |␊
      3 | const hasCompleted = () => completed␊
      4 | const hasCompleted2 = () => completed␊
      5 | const hasCompleted3 = () => completed␊
      6 | const hasCompleted4 = () => completed␊
    `
...
> Error 1/1
    ...
    Suggestion 1/5: Replace \`completed\` with \`isCompleted\`.␊
      ...
      2 |␊
      3 | const hasCompleted = () => isCompleted␊
      4 | const hasCompleted2 = () => isCompleted␊
      5 | const hasCompleted3 = () => isCompleted␊
      6 | const hasCompleted4 = () => isCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 2/5: Replace \`completed\` with \`wasCompleted\`.␊
      1 | const wasCompleted = true␊
      2 |␊
      3 | const hasCompleted = () => wasCompleted␊
      4 | const hasCompleted2 = () => wasCompleted␊
      5 | const hasCompleted3 = () => wasCompleted␊
      6 | const hasCompleted4 = () => wasCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 3/5: Replace \`completed\` with \`hasCompleted\`.␊
      1 | const hasCompleted5 = true␊
      2 |␊
      3 | const hasCompleted = () => hasCompleted5␊
      4 | const hasCompleted2 = () => hasCompleted5␊
      5 | const hasCompleted3 = () => hasCompleted5␊
      6 | const hasCompleted4 = () => hasCompleted5␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 4/5: Replace \`completed\` with \`canCompleted\`.␊
      1 | const canCompleted = true␊
      2 |␊
      3 | const hasCompleted = () => canCompleted␊
      4 | const hasCompleted2 = () => canCompleted␊
      5 | const hasCompleted3 = () => canCompleted␊
      6 | const hasCompleted4 = () => canCompleted␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 5/5: Replace \`completed\` with \`shouldCompleted\`.␊
      1 | const shouldCompleted = true␊
      2 |␊
      3 | const hasCompleted = () => shouldCompleted␊
      4 | const hasCompleted2 = () => shouldCompleted␊
      5 | const hasCompleted3 = () => shouldCompleted␊
      6 | const hasCompleted4 = () => shouldCompleted␊
    `
...
## invalid(2): const completed = hasCompleted as boolean

> Input

    `␊
      1 | const completed = hasCompleted as  boolean␊
    `
...
> Error 1/1
    ...
    --------------------------------------------------------------------------------␊
    Suggestion 1/5: Replace \`completed\` with \`isCompleted\`.␊
      1 | const isCompleted = hasCompleted as  boolean␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 2/5: Replace \`completed\` with \`wasCompleted\`.␊
      1 | const wasCompleted = hasCompleted as  boolean␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 3/5: Replace \`completed\` with \`hasCompleted\`.␊
      1 | const hasCompleted = hasCompleted as  boolean␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 4/5: Replace \`completed\` with \`canCompleted\`.␊
      1 | const canCompleted = hasCompleted as  boolean␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 5/5: Replace \`completed\` with \`shouldCompleted\`.␊
      1 | const shouldCompleted = hasCompleted as  boolean␊
    `

## invalid(3): const completed = hasCompleted() as boolean
...
## invalid(4): var hasCompleted: boolean const downloaded = hasCompleted
...
## invalid(5): function hasCompleted(): boolean {} const downloaded = hasCompleted()
...
## invalid(7): function foo(bar: boolean) { console.log(bar) }

> Input

    `␊
      1 | function foo(bar: boolean) {␊
      2 |   console.log(bar)␊
      3 | }␊
    `
...
> Error 1/1
    ...
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 1/5: Replace \`bar\` with \`isBar\`.␊
      1 | function foo(isBar: boolean) {␊
      2 |   console.log(isBar)␊
      3 | }␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 2/5: Replace \`bar\` with \`wasBar\`.␊
      1 | function foo(wasBar: boolean) {␊
      2 |   console.log(wasBar)␊
      3 | }␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 3/5: Replace \`bar\` with \`hasBar\`.␊
      1 | function foo(hasBar: boolean) {␊
      2 |   console.log(hasBar)␊
      3 | }␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 4/5: Replace \`bar\` with \`canBar\`.␊
      1 | function foo(canBar: boolean) {␊
      2 |   console.log(canBar)␊
      3 | }␊
    ␊
    --------------------------------------------------------------------------------␊
    Suggestion 5/5: Replace \`bar\` with \`shouldBar\`.␊
      1 | function foo(shouldBar: boolean) {␊
      2 |   console.log(shouldBar)␊
      3 | }␊
    `
