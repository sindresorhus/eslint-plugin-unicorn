...
## invalid(22): (array as Foo[])[array.length - 1]
...
## invalid(23): (array as Foo[])[(array as Foo[]).length - 1]
...
## invalid(24): <Foo[]>array[array.length - 1]
...
## invalid(25): <Foo[]>array[(<Foo[]>array).length - 1]
...
## invalid(27): array![array!.length - 1]
