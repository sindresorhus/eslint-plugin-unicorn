...
## invalid(8): string.substring(index, /* comment */ index + 1)
...
## invalid(9): string.substring(index, index + /* comment */ 1)
...
## invalid(10): string.substring((( index )), (( index )) + 1)
...
## invalid(11): string.substring((( index )) - 1, (( index )))
