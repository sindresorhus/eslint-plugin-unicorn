...
## Invalid #3 1 | const foo = (1 + 2 / 3.4) | 0;
...
## Invalid #4 1 | const foo = bar((1.4 | 0) + 2);
...
## Invalid #6 1 | function foo() {return.1 | 0;}
...
## Invalid #9 1 | const foo = 1.4 | 0.0000_0000_0000;
...
## Invalid #10 1 | const foo = 1.4 | 0b0;
...
## Invalid #11 1 | const foo = 1.4 | 0x0000_0000_0000;
...
## Invalid #12 1 | const foo = 1.4 | 0o0;
...
## Invalid #13 1 | const foo = 1.23 | 0 | 4;
...
## Invalid #16 1 | const foo = ~~(1 + 2 / 3.4);
...
## Invalid #17 1 | const foo = ~~1 + 2 / 3.4;
...
## Invalid #24 1 | function foo() {return~~3.9;}
...
## Invalid #28 1 | function foo() {return.1 ^0;}
...
## Invalid #29 1 | const foo = {a: {b: {c: 3}}}; 2 | const bar = a.b.c | 0;
...
## Invalid #30 1 | const foo = {a: {b: {c: 3}}}; 2 | const bar = a.b?.c | 0;
...
## Invalid #31 1 | const foo = {a: {b: {c: 3}}}; 2 | const bar = ~~a.b?.c;
...
## Invalid #32 1 | const foo = 3; 2 | const bar = foo | 0;
...
## Invalid #33 1 | const foo = 3; 2 | const bar = ~~foo;
...
## Invalid #34 1 | let foo = 2; 2 | foo |= 0;
...
## Invalid #35 1 | const foo = {a: {b: 3.4}}; 2 | foo.a.b |= 0;
...
## Invalid #36 1 | const foo = 10.01; 2 | const bar = ~~foo;
...
## Invalid #37 1 | let foo = 10.01; 2 | foo >>= 0;
...
## Invalid #38 1 | let foo = 10.01; 2 | foo <<= 0;
...
## Invalid #39 1 | let foo = 10.01; 2 | foo ^= 0;
...
## Invalid #40 1 | function foo() {return[foo][0] ^= 0;};
...
## Invalid #41 1 | const foo = /* first comment */ 3.4 | 0; // A B C
...
## Invalid #42 1 | const foo = /* first comment */ ~~3.4; // A B C
...
## Invalid #43 1 | const foo = {a: {b: 3.4}}; 2 | foo /* Comment 1 */ .a /* Comment 2 */ . /* Comment 3 */ b |= /* Comment 4 */ 0 /* Comment 5 */;
...
## Invalid #44 1 | const foo = {a: {b: 3.4}}; 2 | const bar = /* Comment 1 */ ~~ a /* Comment 3 */ . /* Comment 4 */ b /* Comment 5 */;
...
## Invalid #45 1 | const foo = /* will keep */ 3.4 /* will remove 1 */ | /* will remove 2 */ 0;
...
## Invalid #46 1 | const foo = /* will keep */ ~ /* will remove 1 */ ~ /* will remove 2 */ 3.4;
...
## Invalid #47 1 | const foo = 3.4; // comment 1 2 | foo |= 0; // comment 2
...
## Invalid #48 1 | const foo = 3.4; // comment 1 2 | const bar = ~~foo; // comment 2
...
## Invalid #51 1 | const foo = bar | 0 | 0;
...
## Invalid #52 1 | const foo = ~~~~((bar | 0 | 0) >> 0 >> 0 << 0 << 0 ^ 0 ^0);
...
## Invalid #53 1 | const foo = Array.from({length: 10}, (_, index) => (index + 1) + (index + 1) /100); 2 | let i = 0; 3 | while (i < foo.length) { 4 | foo[i++] |= 0; 5 | } 6 | console.log(foo);
