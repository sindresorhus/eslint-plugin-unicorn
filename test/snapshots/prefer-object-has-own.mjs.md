...
> Error 1/1
    ...
    `␊
    > 1 | _.has(object, property)␊
        | ^^^^^ Use \`Object.hasOwn(…)\` instead of \`_.has.call(…)\`.␊
    `
...
> Error 1/1
    ...
    `␊
    > 1 | lodash.has(object, property)␊
        | ^^^^^^^^^^ Use \`Object.hasOwn(…)\` instead of \`lodash.has.call(…)\`.␊
    `
...
> Error 1/1
    ...
    `␊
    > 1 | underscore.has(object, property)␊
        | ^^^^^^^^^^^^^^ Use \`Object.hasOwn(…)\` instead of \`underscore.has.call(…)\`.␊
    `
...
> Error 1/1
    ...
    `␊
    > 1 | utils.has(object, property)␊
        | ^^^^^^^^^ Use \`Object.hasOwn(…)\` instead of \`utils.has.call(…)\`.␊
    `
