...
## invalid(14): foo = (await Promise.all([promise]))[0]
...
## invalid(15): const [foo] = await Promise.all([a ? b : c])
...
## invalid(16): const [foo = bar] = await Promise.all([promise])
...
## invalid(17): const [...foo] = await Promise.all([promise])
...
## invalid(19): const result = ([foo] = await Promise.all([promise]))
...
## invalid(20): const foo = (await Promise.all([promise]))[1]
...
## invalid(21): const foo = (await Promise.all([promise])) /* comment */ [0]
...
## invalid(22): const [/* comment */ foo] = await Promise.all([promise])
...
## invalid(23): const [foo] = await Promise.all([/* comment */ promise])
...
## invalid(24): const [foo]: [Foo] = await Promise.all([promise])
