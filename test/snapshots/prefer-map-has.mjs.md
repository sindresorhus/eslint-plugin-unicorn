...
## invalid(16): function foo(isBoolean = !!map.get("key")) { }

> Input

    `␊
      1 | function foo(isBoolean = !!map.get("key")) { }␊
    `
...
> Error 1/1
    ...
    --------------------------------------------------------------------------------␊
    Suggestion 1/1: Replace \`!!map.get("key")\` with \`map.has("key")\`.␊
      1 | function foo(isBoolean = map.has("key")) { }␊
    `

## invalid(17): if (a || map.get(foo) || b || c) { }

> Input

    `␊
      1 | if (a || map.get(foo) || b || c) {␊
      2 |␊
      3 | }␊
    `
